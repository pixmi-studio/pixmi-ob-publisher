...
describe('Medium Geek Theme Optimization', () => {
    it('should have optimized font sizes and padding in medium-geek theme', () => {
        ...
        // Target: h1 ~1.5em (24px), h2 ~1.3em (21px), h3 ~1.1em (18px), h4 ~1em (16px)
        expect(css).toContain('h1 { font-size: 24px !important;');
        expect(css).toContain('h2 { font-size: 21px !important;');
